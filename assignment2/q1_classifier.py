...
class SoftmaxModel(Model):
  ...
  def add_model(self, input_data):
    ...
    self.W = tf.get_variable("weights", W_shape, initializer = tf.zeros_initializer())
    self.b = tf.get_variable("bias", b_shape, initializer = tf.zeros_initializer())

    z = tf.matmul(input_data, self.W) + self.b
